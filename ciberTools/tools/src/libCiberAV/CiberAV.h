 ...
 * \param pos Robot's position and orientation in starting grid
 */
 ...
 * \param cnt The number of cycles to apply
 */
 ...
 * \details Only available if the GPS is available. The measure is noisy.
