...
public interface MusListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MusParser#logicalop}.
	 * @param ctx the parse tree
	 */
	void enterLogicalop(MusParser.LogicalopContext ctx);
	/**
	 * Exit a parse tree produced by {@link MusParser#logicalop}.
	 * @param ctx the parse tree
	 */
	void exitLogicalop(MusParser.LogicalopContext ctx);
	/**
